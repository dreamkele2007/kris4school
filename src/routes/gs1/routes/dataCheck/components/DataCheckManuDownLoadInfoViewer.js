...
import Processor from './dataChekManuDownLoadInfoProcessor';
...
class ManuDownLoadInfoViewer extends Component{
  ...
  render() {
    ...
    return (
      <div>
          <Button type="primary">
            <Link to={`/gs1/result/ResultViewer`}>返回</Link>
          </Button>
