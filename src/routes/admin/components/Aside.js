          ...
          <TabPane tabId="1">
            ...
            <div className="callout callout-warning m-0 py-3">
              <div className="avatar float-right">
                <img src={APPCONFIG.PublicURL+'assets/images/avatars/7.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
              </div>
            ...
            <div className="callout callout-info m-0 py-3">
              <div className="avatar float-right">
                <img src={APPCONFIG.PublicURL+'assets/images/avatars/4.jpg'} className="img-avatar" alt="admin@bootstrapmaster.com"/>
              </div>
