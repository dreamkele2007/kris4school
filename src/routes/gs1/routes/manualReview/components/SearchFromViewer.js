...
class SearchFromViewer extends Component {
  ...
  componentWillMount() {
    ...
    processor.loadData({total:0,pageSize:10,current:1,defaultCurrent:1},this.props,submitId,"notAudited");
  ...
  handleSubmit = (e) => {
    ...
    if(this.props.name==='haveAudit'){
      this.props.form.setFieldsValue({
        matchDegree:'',
      })
    }
    processor.loadData({total:0,pageSize:10,current:1,defaultCurrent:1},this.props,this.state.submitId,"notAudited");
        ...
        <Form  layout="inline" onSubmit={this.handleSubmit}>
            <FormItem  label="匹配度">
              {getFieldDecorator('matchDegree', {
                ...
                <Select  allowClear style={{width:122}}>
