...
import taskManagerProcessor from './taskManagerProcessor';
import TaskModelViewer from './TaskModelViewer';

var timer = '';
const  processor = new taskManagerProcessor();
class TaskManagerViewer extends React.Component {
  // 初始化props
  constructor(props) {
    ...
    return (
      <div>
        <div style={{width:'100%',display:'inline-block'}}>
          <TaskModelViewer  record={this.state.record} selectedRowKeys={selectedRowKeys}
...
const mapStateToProps = (store) => {
  return {
    data:store.taskReducer.data,
    pagination:store.taskReducer.pagination
  }
};

// const  TaskMainViewer =Form.create()(TaskManagerViewer);
